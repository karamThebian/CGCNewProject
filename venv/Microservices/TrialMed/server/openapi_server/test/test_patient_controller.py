...
class TestPatientController(BaseTestCase):
  ...
  "username" : "username"
    ...
    @unittest.skip("Connexion does not support multiple consumes. See https://github.com/zalando/connexion/pull/760")
    def test_add_patient_medication(self):
        """Test case for add_patient_medication
  ...
  "methodOfUse" : "methodOfUse"
    ...
    def test_delete_patient(self):
        ...
        response = self.client.open(
            '/api/v1/patient/{idm}'.format(idm=56),
            method='DELETE',
            headers=headers)
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
  ...
  "username" : "username"
    ...
    def test_find_patient_by_username(self):
        """Test case for find_patient_by_username
